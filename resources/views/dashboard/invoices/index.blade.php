    ...
    <form class="filter-bar d-flex flex-wrap align-items-end gap-2">
        ...
        <div>
            ...
            <select name="sort" class="form-select form-select-compact">
                @foreach(['created_at'=>'Newest','invoice_number'=>'Invoice','total'=>'Total','status'=>'Status','issue_date'=>'Issue date'] as $key=>$label)
        ...
        <a href="{{ route('dashboard.invoices') }}" class="btn btn-outline-secondary" title="Reset"><i class="fa-solid fa-rotate-left"></i></a>
    </form>
</div>
...
<div class="panel p-3">
    <div class="table-responsive">
        <table class="table align-middle mb-0">
            ...
            @empty
                <tr><td colspan="4" class="text-center text-muted py-5"><i class="fa-solid fa-inbox fa-2x d-block mb-2"></i>No invoices found.</td></tr>
            @endforelse
            </tbody>
        </table>
    </div>
